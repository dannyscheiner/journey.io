...
const signupQuery = "INSERT INTO users (username, pw) VALUES ($1, $2)";
const loginQuery = "SELECT pw, _id FROM users WHERE username=$1";
const updateCookie = "UPDATE users SET cookie=$1 WHERE _id=$2";
const verifyCookie = "SELECT cookie FROM users WHERE _id=$1";
...
userController.verifyCookie = (req, res, next) => {
    ...
    db.query(verifyCookie, [req.cookies.toDoI])
      .then(verif => {
